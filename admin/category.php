                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    foreach($query_run as $row)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['name']; ?></td>
                                            <td>
                                                <img src="../uploads/<?= $row['image']; ?>" alt="category image" width="50px" height="50px">    
                                            </td>
                                            <td>
                                                <?php
                                                if($row['status'] == '0')
                                            ...
                                            <td><a href="edit-category.php?id=<?= $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                                            <td><a href="delete-category.php?id=<?= $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
